...
const things = ['Shirt', 'Window', 'Twister', 'Box', 'Radio', 'Apple', 'Keyboard', 'Chair', 'Bow', 'Album', 'Jar', 'Tire', 'Swing', 'Cup', 'House', 'Phone', 'Pen', 'Desk', 'Clock', 'Wheel', 'Bag', 'Belt', 'Cable', 'Wire', 'Car', 'Wallet', 'Truck', 'Tie', 'Magnet', 'Bike', 'Television', 'Brush', 'Pencil', 'Tractor', 'Bottle', 'Pebble', 'Boat', 'Chalk', 'Book', 'Van', 'Key', 'Remote', 'Rope', 'Handle', 'Gear', 'Chain', 'Knob', 'Cap', 'Watch', 'Trolley'];
const colors = ['Magenta','Coral','Bisque','Orange','Red','Azure','Turquoise','Green','Blue','Wheat','Peach','Violet','Ivory','Olive','Salmon','Green','Pink','Peru','Golden','Crimson','Orchid','Yellow','Gray','Aquamarine','Sienna','Thistle','Cyan','Silver','Beige','Purple','Cornsilk','Linen','Moccasin','Lavender','Cornflower','Lime','Indigo','Gainsboro','Tan','Khaki','Mint','Teal','Chartreuse','Lemon','Fuchsia'];
